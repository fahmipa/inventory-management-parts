                ...
                <form method='get' action='pages/Inventory/edit_data.php'>
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>DEPT</label>
                        <input type="text" class="form-control" name='dept' placeholder="ENTER DEPT ..." value="<?php echo $view['dept'];?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>PLANT</label>
                        <input type="text" class="form-control" name='plant' placeholder="ENTER PLANT ..." value="<?php echo $view['plant'];?>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
